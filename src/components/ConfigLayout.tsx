 ...
 * Voice / Log / About。
 *
 * 这里也负责关闭「切 Tab 时整页 pageEnter 动画」的副作用：外层 <main>
 * 不再按 pathname 重 mount，ConfigLayout 自身保持常驻，<Outlet /> 只
 * 替换当前 Tab 内容，连接 / 心跳 / 快照都不会丢。
 */

import { NavLink, Outlet } from "react-router-dom";
import { useI18n } from "../i18n/useI18n.tsx";
import { DeviceSessionProvider } from "../hooks/DeviceSessionContext";
