...
export const DICT: Record<Lang, Dict> = {
  en: {
    ...
    "site.title.model3d": "3D Model · EKeys",

    /* ---------------- 3D Model page ---------------- */
    "model3d.hero.eyebrow": "3D · LIVE PREVIEW",
    "model3d.hero.title.1": "EKeys",
    "model3d.hero.title.2": "3D Model",
    "model3d.hero.lede":
      "A real-time 3D model built with Three.js. The keyboard is <strong>80 × 93 × 18 cm</strong> overall — a 428 : 124 LCD strip across the top, a 3 × 4 key matrix below, and a rotary encoder on the top-right corner.",
    "model3d.hero.cta.primary": "VIEW SPECS",
    "model3d.hero.cta.secondary": "← BACK HOME",
    "model3d.specs.eyebrow": "DIMENSIONS",
    "model3d.specs.title": "Build Sheet",
    "model3d.specs.lede":
      "A 18 cm-deep shell that contains the recessed panel, the screen bezel, the key columns and the protruding encoder. The center of gravity stays centered so it plants firmly on a desk.",
    "model3d.specs.01.title": "Chassis",
    "model3d.specs.01.label.0": "WIDTH",
    "model3d.specs.01.label.1": "HEIGHT",
    "model3d.specs.01.label.2": "DEPTH",
    "model3d.specs.01.label.3": "BEVEL",
    "model3d.specs.01.value.0": "80 cm",
    "model3d.specs.01.value.1": "93 cm",
    "model3d.specs.01.value.2": "18 cm",
    "model3d.specs.01.value.3": "0.6 cm",
    "model3d.specs.02.title": "LCD Panel",
    "model3d.specs.02.label.0": "RATIO",
    "model3d.specs.02.label.1": "SIZE",
    "model3d.specs.02.label.2": "DEPTH",
    "model3d.specs.02.label.3": "EMISSIVE",
    "model3d.specs.02.value.0": "428 : 124",
    "model3d.specs.02.value.1": "72 × 20.9 cm",
    "model3d.specs.02.value.2": "0.4 cm",
    "model3d.specs.02.value.3": "0.7–0.85",
    "model3d.specs.03.title": "Key Matrix",
    "model3d.specs.03.label.0": "GRID",
    "model3d.specs.03.label.1": "KEY SIZE",
    "model3d.specs.03.label.2": "GAP",
    "model3d.specs.03.label.3": "TRAVEL",
    "model3d.specs.03.value.0": "3 × 4",
    "model3d.specs.03.value.1": "~15.95 × 23.27 cm",
    "model3d.specs.03.value.2": "2.2 cm",
    "model3d.specs.03.value.3": "3.5 cm",
    "model3d.specs.04.title": "Encoder (R1·C4)",
    "model3d.specs.04.label.0": "RADIUS",
    "model3d.specs.04.label.1": "HEIGHT",
    "model3d.specs.04.label.2": "KNURL",
    "model3d.specs.04.label.3": "INDICATOR",
    "model3d.specs.04.value.0": "~8.17 cm",
  ...
  zh: {
    ...
    "site.title.model3d": "3D 模型 · EKeys",

    /* ---------------- 3D 模型页面 ---------------- */
    "model3d.hero.eyebrow": "3D · 实时预览",
    "model3d.hero.title.1": "EKeys",
    "model3d.hero.title.2": "3D 模型",
    "model3d.hero.lede":
      "基于 Three.js 构建的实时 3D 模型。键盘整体<strong> 80 × 93 × 18 cm</strong>,顶部为 428 : 124 比例的 LCD 屏幕,下方为 3 × 4 按键矩阵,右上角为旋钮。",
    "model3d.hero.cta.primary": "查看参数",
    "model3d.hero.cta.secondary": "← 返回首页",
    "model3d.specs.eyebrow": "结构尺寸",
    "model3d.specs.title": "构建清单",
    "model3d.specs.lede":
      "外壳深度 18 cm,容纳面板凹陷、屏幕边框、按键柱体与突出的旋钮。重心居中,落地稳定。",
    "model3d.specs.01.title": "外壳",
    "model3d.specs.01.label.0": "宽度",
    "model3d.specs.01.label.1": "高度",
    "model3d.specs.01.label.2": "深度",
    "model3d.specs.01.label.3": "倒角",
    "model3d.specs.01.value.0": "80 cm",
    "model3d.specs.01.value.1": "93 cm",
    "model3d.specs.01.value.2": "18 cm",
    "model3d.specs.01.value.3": "0.6 cm",
    "model3d.specs.02.title": "LCD 面板",
    "model3d.specs.02.label.0": "比例",
    "model3d.specs.02.label.1": "尺寸",
    "model3d.specs.02.label.2": "深度",
    "model3d.specs.02.label.3": "自发光",
    "model3d.specs.02.value.0": "428 : 124",
    "model3d.specs.02.value.1": "72 × 20.9 cm",
    "model3d.specs.02.value.2": "0.4 cm",
    "model3d.specs.02.value.3": "0.7–0.85",
    "model3d.specs.03.title": "按键矩阵",
    "model3d.specs.03.label.0": "布局",
    "model3d.specs.03.label.1": "按键尺寸",
    "model3d.specs.03.label.2": "间隙",
    "model3d.specs.03.label.3": "键程",
    "model3d.specs.03.value.0": "3 × 4",
    "model3d.specs.03.value.1": "约 15.95 × 23.27 cm",
    "model3d.specs.03.value.2": "2.2 cm",
    "model3d.specs.03.value.3": "3.5 cm",
    "model3d.specs.04.title": "旋钮 (R1·C4)",
    "model3d.specs.04.label.0": "半径",
    "model3d.specs.04.label.1": "高度",
    "model3d.specs.04.label.2": "滚花",
    "model3d.specs.04.label.3": "指示灯",
    "model3d.specs.04.value.0": "约 8.17 cm",
    "model3d.specs.04.value.1": "6 cm",
